                    ...
                    <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                        <a href="" className="text-decoration-none">
                            <h1 className="mb-4 display-5 font-weight-semi-bold"><span
                                className="text-primary font-weight-bold border border-white px-3 mr-1">K</span>Shop</h1>
                        </a>
                        <p>The best electrics shop for you</p>
                        <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>Ho Chi Minh City, New York, USA</p>
